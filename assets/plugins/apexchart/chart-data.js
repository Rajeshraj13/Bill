...
$(document).ready(function () {
  ...
  if ($("#earnings-chart").length > 0) {
    var options = {
      ...
      plotOptions: {
        bar: { borderRadius: 50, borderRadiusApplication: "around" },
      },
      dataLabels: { enabled: false },
      colors: ["#7539FF"],
      xaxis: {
  ...
  if ($("#companies_flow").length > 0) {
    var options = {
      series: [
        { name: "Companies", data: [25, 40, 30, 55, 25, 35, 25, 50, 20] },
      ],
      chart: { height: 273, type: "area", zoom: { enabled: false } },
      colors: ["#FF9F43"],
      dataLabels: { enabled: false },
      stroke: { curve: "straight" },
  ...
  if ($("#plane-chart").length > 0) {
    var options = {
      series: [{ data: [400, 325, 312, 294, 254, 252] }],
      chart: { type: "bar", height: 300 },
      plotOptions: {
        bar: { barHeight: "100%", distributed: true, horizontal: true },
      },
      dataLabels: { enabled: false },
      colors: [
        "#FFEFDD",
